...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser">Add Supervisor</button>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <?php foreach ($supervisors as $supervisor): ?>
            <tr>
              <td><?php echo $supervisor['username']; ?></td>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
  ...
  <div class="offcanvas-body mx-0 flex-grow-0 h-100">
    <form class="add-new-user pt-0 fv-plugins-bootstrap5 fv-plugins-framework" id="addNewUserForm" method="POST" action="<?php if ($_SESSION['user']['role'] == 'admin') {
                                                                                                                            $this->router->generate('add_supervisor');
                                                                                                                          } ?>">
