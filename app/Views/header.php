                      ...
                      <li class="list-group-item list-group-item-action dropdown-notifications-item waves-effect waves-light">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="mb-1 d-block text-body">New unread notifiaction body</small>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <div class="d-grid px-4 pt-2 pb-1">
                      <a class="btn btn-sm btn-danger d-flex waves-effect waves-light" href="<?= $this->router->generate('logout'); ?>">
